        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item <?php echo $menu=='form ajukan pentest' ? 'menu-open' : '' ?>">
                            <a href="#" class="nav-link <?php echo $menu=='form ajukan pentest' ? 'active' : '' ?>">
                                <i class="nav-icon fas fa-edit"></i>
                                <p>
                                    Forms
                                    <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url('AjukanPentest')?>"
                                        class="nav-link <?php echo $submenu=='ajukan pentest' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Ajukan Pentest</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item <?php echo $menu=='tabel' ? 'menu-open' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url('TabelPentestUser')?>"
                                        class="nav-link <?php echo $submenu=='tabel pentest' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tabel Data Pentest</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url('TabelDataPemohonUser')?>"
                                        class="nav-link <?php echo $submenu=='tabel data pemohon' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tabel Data Pemohon</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url('TabelDataInstansiUser')?>"
                                        class="nav-link <?php echo $submenu=='tabel data instansi' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tabel Daftar Instansi</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url('TabelUserUser')?>"
                                        class="nav-link <?php echo $submenu=='tabel user' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tabel User</p>
                                    </a>
